...
max_new_tokens=128
steering_alpha=1
hook_names=("shift_hidden_states_learned_steer" "captioning_metrics") # should add the evaluation right here
...
for split in adversarial popular random; do
    ...
    for i in 14; do
        ...
        save_filename="${model}_${dataset_name}_steer_${i}_yes_no_${subset}_${steering_alpha}_${steer_model_base}"
