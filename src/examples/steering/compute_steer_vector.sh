...
save_dir=/home/khayatan/xl_vlms_cvpr/xl-vlms/results/features
max_new_tokens=5
...
for i in "${!layers[@]}"; do
    ...
    --features_path ${save_dir}/${hook_names}_${model}_${layer}_${token_of_interests[0]}.pth ${save_dir}/${hook_names}_${model}_${layer}_${token_of_interests[1]}.pth \
